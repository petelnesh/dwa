...
//        });
    ...
    private void getResponse(String phoneNumber,  String checkout,String totalCostPrice) {
        ...
        Thread thread = new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    jsonParam.put("accountReference", "peterson Munene");
...
System.out.println("phone"+ phoneNumber);
        ...
        jsonParam.put("amount", String.valueOf(totalCostPrice));
